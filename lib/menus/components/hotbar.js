...
class Hotbar extends LitElement {
  ...
  init () {
    ...
    document.addEventListener('wheel', (e) => {
      if (document.getElementById('hud').shadowRoot.querySelector('#chat').inChat) return
    ...
    document.addEventListener('keydown', (e) => {
      ...
      if (e.code.startsWith('Digit')) {
        const numPressed = e.code.replace('Digit', '')
    ...
    this.bot.on('heldItemChanged', () => {
      this.reloadHotbarSelected(this.bot.quickBarSlot)
    })
