  ...
  static get styles () {
    return css`
      .edit-container {
        ...
        width: 200px;
        height: 20px;
        background: var(--c-editBox);
        border: 1px solid var(--c-editBoxBorder);
        border-radius: 2px;
        transition: background-color 1s ease, border-color 0.25s ease;
      }

      .edit-container:hover,
      .edit-container:focus-within {
        border-color: var(--c-editBoxBorderHover);
      }
